...
# change to possibly() because failwith() is now deprecated
safe.runsteady <- purrr::possibly(otherwise = structure(list(y = c(R1 = NA, R2 = NA, C1 = NA, C2 = NA)), steady = 0), runsteady.ps)
